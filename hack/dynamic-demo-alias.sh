...
alias nodepublishvolumepod2readonly="csc node publish --staging-target-path=/tmp/kubelet/plugins/beegfs/volume1 --target-path=/tmp/kubelet/pods/pod2/volumes/volume1 --cap MULTI_NODE_MULTI_WRITER,mount, --vol-context=volDirBasePath=scratch --read-only beegfs://${SYS_MGMTD_HOST}/scratch/volume1"
...
alias validatevolumecapabilitiesfail="csc controller validate-volume-capabilities --cap MULTI_NODE_MULTI_WRITER,block, beegfs://${SYS_MGMTD_HOST}/scratch/volume1"
