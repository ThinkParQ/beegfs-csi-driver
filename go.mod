...
require (
	...
	// WARNING: filepath-securejoin is MPL 2.0 license (copyleft) but marked as an exception in the
	// Makefile's test-licenses check since our current usage compiles with the MPL 2.0 license.
	// Reevaluate if usage changes in the project changes.
