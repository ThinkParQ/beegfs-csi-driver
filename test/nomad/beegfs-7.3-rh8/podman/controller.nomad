  ...
  group "controller" {
    ...
    task "controller" {
      ...
      config {
        ...
        # TODO(webere, A511): Go back to using mount blocks (as we do for the Docker driver) when 
        ...
        volumes = [
          ...
          "/opt/nomad/client/csi/controller/beegfs-csi-plugin:/opt/nomad/client/csi/controller/beegfs-csi-plugin:rslave"
        ]
